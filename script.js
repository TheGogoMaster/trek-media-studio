...
// ============================================
// REST OF YOUR FUNCTIONS (keep all other functions the same)
// ============================================
...
function renderBeats() {
    ...
    document.querySelectorAll('.btn-preview').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (currentPlayingCardId === beatId && audioPlayer.isPlaying) {
                audioPlayer.pause();
            ...
            document.querySelectorAll('.btn-preview').forEach(otherBtn => {
            ...
            showNotification(`Now playing: ${beatTitle}`);
        });
    });
...
function renderMixes() {
    ...
    document.querySelectorAll('.btn-listen').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (currentPlayingCardId === mixId && audioPlayer.isPlaying) {
                audioPlayer.pause();
                playIcon.className = 'fas fa-play';
                this.classList.remove('playing');
                currentPlayingCardId = null;
            ...
            showNotification(`Now playing: ${mixTitle}`);
        });
    });
}
...
function initDataManagement() {
    ...
    if (clearAllBeatsBtn) {
        clearAllBeatsBtn.addEventListener('click', () => {
            if (confirm("WARNING: This will delete ALL beats from cloud storage. Are you sure?")) {
    ...
    if (clearAllFeedbackBtn) {
        clearAllFeedbackBtn.addEventListener('click', () => {
            if (confirm("WARNING: This will delete ALL feedback. Are you sure?")) {
